    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginViewModel user)
        {
            ...
            try
            {
                ...
                if(_userContext.User != null)
                {
                    ...
                    await HttpContext.Authentication.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme, new ClaimsPrincipal(new ClaimsIdentity(_claims, CookieAuthenticationDefaults.AuthenticationScheme)), new Microsoft.AspNetCore.Http.Authentication.AuthenticationProperties { IsPersistent = user.RememberMe });
        ...
        public IActionResult Register([FromBody] RegistrationViewModel user)
        {
            ...
            try
            {
                ...
                {
                    _registrationResult = new Infrastructure.Core.GenericResult()
                    {
                        Succeeded = false,
